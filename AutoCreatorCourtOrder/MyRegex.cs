...
namespace AutoCreatorCourtOrder
{
    ...
    static class MyRegex
    {
        ...
        /// <summary>
        /// Находит ФИО. Слова между "Должник" и почтовым индексом являются ФИО. 
        /// </summary>
        public static string FullName { get { return @"(?<=Должник\W*)([А-ЯЁа-яё]+[\-\s]+){2,}"; } }
        ...
        /// <summary>
        /// Находит место рождения. Подстрока от следующего слова после "Место рождения" 
        /// и до пробельных символов перед словом "Общая".
        /// </summary>
        public static string BirthPlace { get { return @"(?<=Место\s*рождения\W+)\w.+?(?=\s*Общая)"; } }
